...
import { useGroupById } from '@/api/group.api'
import { useTenantList } from '@/api/tenant.api'
import GroupForm from '@/components/admin/groups/GroupForm'
import { authRedirect } from '@/lib/authRedirect'

export const Route = createFileRoute('/admin/groups/$groupId/duplicate')({
  beforeLoad: authRedirect,
  component: GroupDuplicatePage,
})

function GroupDuplicatePage() {
  ...
  if (groupLoading || tenantsLoading) {
    return (
